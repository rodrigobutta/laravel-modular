    ...
    */
    ...
    'disks'   => [
        ...
        'dropbox'   => [
            ...
            'storageFolder'    => 'Public/dropaccount',
            'userId'           => env('DROPBOX_USER_ID')
        ],
        'copy'      => [
            'driver'         => 'copy',
            'consumerKey'    => env('COPY_CONSUMER_KEY'),
            'consumerSecret' => env('COPY_CONSUMER_SECRET'),
            'accessToken'    => env('COPY_ACCESS_TOKEN'),
            'tokenSecret'    => env('COPY_TOKEN_SECRET')
        ]
