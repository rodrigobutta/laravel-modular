...
(function() {
  ...
  HTMLString.String = (function() {
    ...
    String.prototype.format = function() {
      ...
      // ** llega cuando hay que agregar un tag a un texto

      var c, i, newString, _i;
      var from = arguments[0];
      var to = arguments[1];
      var tags = 3 <= arguments.length ? __slice.call(arguments, 2) : [];
...
(function() {
  ...
  ContentEdit.Node = (function() {
    ...
    Node.prototype.html = function(indent) {
      // console.log('Node.prototype.html');
    ...
    Node.prototype.taint = function() {
      // ** marcar para guardar por cambios
      // console.log('Node.prototype.taint');
  ...
  // creacion del elemento con el super
  ContentEdit.Element = (function(_super) {
    __extends(Element, _super);

    function Element(tagName, attributes, label, elementName, contents) {
    ...
    Element.prototype.mount = function() {
      // console.log('Element.prototype.mount ' + this.tagName());
  ...
  ContentEdit.ElementCollection = (function(_super) {
    ...
    function ElementCollection(tagName, attributes, label, elementName, contents) {
      ElementCollection.__super__.constructor.call(this, tagName, attributes, label, elementName, contents);
    ...
    ElementCollection.prototype.html = function(indent) {
      // console.log('ElementCollection.prototype.html');
      //** el que crea el elemento
      ...
      // agregado del primer if, si tiene contenidos y no children es que es un bloque con consas y no cosas editables dentro
      if(children.length == 0  && (typeof this._contents != 'undefined' || this._contents != '' )){
    ...
    ElementCollection.prototype.mount = function() {
      //** viene de NodeCollection.prototype.attach

      var child, name, value, _i, _len, _ref1, _results;
      this._domElement = document.createElement(this._tagName);

      var _ref = this._attributes;
      for (name in _ref) {
        value = _ref[name];
        this._domElement.setAttribute(name, value);
      }
      ...
      if(typeof this._contents !== 'undefined'){
        this._domElement.innerHTML = this._contents;
      }
  ...
  ContentEdit.ResizableElement = (function(_super) {
    ...
    function ResizableElement(tagName, attributes, label, elementName) {
      // ResizableElement.__super__.constructor.call(this, tagName, attributes, 'Res' + label, 'res' + elementName);
      ResizableElement.__super__.constructor.call(this, tagName, attributes, label, elementName);
  ...
  ContentEdit.Region = (function(_super) {
    ...
    Region.prototype.html = function(indent) {
      // console.log('Region.prototype.html');
      // **
      ...
      var _ref = this.children;
      var _results = [];

      for (_i = 0, _len = _ref.length; _i < _len; _i++) {

        var el = _ref[_i];
        var html = el.html(indent);
        _results.push(html);

      }

      var str = _results.join('\n').trim();
  ...
  ContentEdit.Static = (function(_super) {
    ...
    function Static(tagName, attributes, content) {
      Static.__super__.constructor.call(this, tagName, attributes, 'Static', 'static');
    ...
    Static.prototype.html = function(indent) {
      // console.log('Static.prototype.html');
  ...
  ContentEdit.Text = (function(_super) {
    ...
    function Text(tagName, attributes, content) {
      Text.__super__.constructor.call(this, tagName, attributes, 'Text', 'text');
    ...
    Text.prototype.html = function(indent) {
      // console.log('Text.prototype.html');
  ...
  ContentEdit.TagNames.get().register(ContentEdit.Text, 'address', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'p');
  ...
  ContentEdit.PreText = (function(_super) {
    ...
    function PreText(tagName, attributes, content) {
      ...
      ContentEdit.Element.call(this, tagName, attributes, 'Pre Text', 'pretext');
    }
...
ContentEdit.Quote = (function(_super) {
    __extends(Quote, _super);

    function Quote(tagName, attributes, content) {
      if (content instanceof HTMLString.String) {
        this.content = content;
      } else {
        this.content = new HTMLString.String(content, true);
      }
      ContentEdit.Element.call(this, tagName, attributes,'Quote','quote');
    }

    Quote.prototype.cssTypeName = function() {
      return 'quote';
    };

    Quote.prototype.type = function() {
      return 'Quote';
    };

    Quote.prototype.typeName = function() {
      return 'Quote';
    };

    Quote.prototype.blur = function() {
      if (this.isMounted()) {
        this._domElement.innerHTML = this.content.html();
      }
      return Quote.__super__.blur.call(this);
    };

    Quote.prototype.html = function(indent) {
      var content;
      if (indent == null) {
        indent = '';
      }
    ...
    Quote.prototype.updateInnerHTML = function() {
      var html;
      html = this.content.html();
      this._domElement.innerHTML = html;
      this._ensureEndZWS();
    ...
    Quote.prototype._keyBack = function(ev) {
      var selection;
      selection = ContentSelect.Range.query(this._domElement);
      if (selection.get()[0] <= this.content.length()) {
        return Quote.__super__._keyBack.call(this, ev);
      }
      selection.set(this.content.length(), this.content.length());
      return selection.select(this._domElement);
    };

    Quote.prototype._keyReturn = function(ev) {
      var cursor, selection, tail, tip;
      ev.preventDefault();
      selection = ContentSelect.Range.query(this._domElement);
      cursor = selection.get()[0] + 1;
    ...
    Quote.prototype._syncContent = function(ev) {
      var newSnapshot, snapshot;
      this._ensureEndZWS();
      snapshot = this.content.html();
      this.content = new HTMLString.String(this._domElement.innerHTML.replace(/\u200B$/g, ''), this.content.preserveWhitespace());
    ...
    Quote.prototype._ensureEndZWS = function() {
      var html, _addZWS;
      if (!this._domElement.lastChild) {
        return;
      }
    ...
    Quote.droppers = {
      'Quote': ContentEdit.Element._dropVert,
      'Static': ContentEdit.Element._dropVert,
      'Text': ContentEdit.Element._dropVert
    };
    ...
    Quote.fromDOMElement = function(domElement) {
      return new this(domElement.tagName, this.getDOMElementAttributes(domElement), domElement.innerHTML);
    };
  ...
  ContentEdit.TagNames.get().register(ContentEdit.Quote, 'blockquote');
  ...
  ContentEdit.Video = (function(_super) {
    ...
    function Video(tagName, attributes, sources) {
      ...
      Video.__super__.constructor.call(this, tagName, attributes, 'Video', 'video');
  ...
  ContentEdit.List = (function(_super) {
    ...
    function List(tagName, attributes) {
      List.__super__.constructor.call(this, tagName, attributes, 'List', 'list');
    }
  ...
  ContentEdit.ListItem = (function(_super) {
    ...
    function ListItem(attributes) {
      ListItem.__super__.constructor.call(this, 'li', attributes, 'List Item', 'listitem');
  ...
  ContentEdit.Table = (function(_super) {
    ...
    function Table(attributes) {
      Table.__super__.constructor.call(this, 'table', attributes, 'Table', 'table');
    }
  ...
  ContentEdit.TableSection = (function(_super) {
    ...
    function TableSection(tagName, attributes) {
      TableSection.__super__.constructor.call(this, tagName, attributes, 'Table Section', 'tablesection');
    }
  ...
  ContentEdit.TableRow = (function(_super) {
    ...
    function TableRow(attributes) {
      TableRow.__super__.constructor.call(this, 'tr', attributes, 'Table Row', 'tablerow');
    }
  ...
  ContentEdit.TableCell = (function(_super) {
    ...
    function TableCell(tagName, attributes) {
      TableCell.__super__.constructor.call(this, tagName, attributes, 'Table Cell', 'tablecell');
    }
    ...
    TableCell.prototype.html = function(indent) {
      // console.log('TableCell.prototype.html');
