...
<div class="row">
    <div class="col-md-12">
        <a href="{{route('admin.sectiontypes.create')}}" class="btn btn-primary">{{ t('Create') }}</a>
    </div>
</div>
    ...
    <script>
        $(function() {
            ...
            $('#table').DataTable({
                ...
                order: [[ 2, "asc" ]],
                ajax: '{!! route('admin.sectiontypes.data', ['type' => $type]) !!}',
                columns: [
                    { data: 'thumbnail', name: 'thumbnail', orderable: false, searchable: false },
                    { data: 'id', name: 'section_types.id'},
                    { data: 'title', name: 'section_types.title' },
                    { data: 'created_at', name: 'section_types.created_at' },
