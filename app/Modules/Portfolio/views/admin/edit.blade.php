...
@section('content')
    ...
    <div class="row">
        <div class="col-md-8">
            <h2 id="item_title">{{t('Edit')}} {{t('Portfolio')}}: <strong>{{$item->title}}</strong></h2>
        </div>
        <div class="col-md-4">
            <div class="pull-right">
             {{--    <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="{{ route('admin.portfolio.clone', [$item->id]) }}"> {{t('Current')}}</a></li>
                        <li><a href="{{ route('admin.portfolio.clonex', [$item->id, 'uy']) }}">Uruguay</a></li>
                        <li><a href="{{ route('admin.portfolio.clonex', [$item->id, 'ch']) }}">Chile</a></li>
                    </ul>
                </div> --}}
    ...
    <div class="row">
        ...
        <div class="col-md-3 sticky-parent">
            ...
            <div class="box box-solid sticky">
                <div class="box-body">
                    ...
                    <img src="{{ Resize::img($item->main_image,$item->receipts['featuredPortfolio']) }}" class="img-responsive">
                   <ul id="nav_index">
                   </ul>
                </div>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="box box-solid box-primary ">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input name="main_image" type="hidden" class="image-field" value="{{$item->main_image}}" data-preview-recipe="featuredPortfolio">
                    </div>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        {!! Form::label('job', 'Trabajo realizado') !!}
                        {!! Form::text('job', $item->job, ['class' => 'form-control', 'placeholder' => '']) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('slug', t('Slug')) !!}
                        <small>Nombre que se usa para identificar el portfolioo en la URL. Debe cumplir con los standares de url.</small>
            ...
            {{--  <div class="box box-solid box-primary">
                ...
                <div class="box-body">
                    <small>Cuando un portfolioo se identifica como micrositio, el comportamiento en el sitio es el mismo que como un portfolioo normal, pero se reemplaza la ficha por un enlace (especificado en el campo de este cuadro) a un sitio externo que abre en <strong>ventana nueva</strong>.</small>
                    <div class="form-group">
            ...
            <div class="box box-solid box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <small>Texto que se muestra en la columna izquierda</small>
            ...
            <div class="box box-solid box-primary">
                ...
                <div class="box-body">
                    @if($item->grid)
                    <div class="form-group">
                        {!! Form::label('grids', 'Grilla del portfolioo') !!}
                        <small>El siguiente botón lleva al editor de grillas para la grilla de este portfolioo.</small>
                        <a href="{{ route('admin.grids.live', [$item->grid->id]) }}" class="btn btn-primary" target="_blank"><i class="fa fa-th-large"></i> {{t('Grid Editor')}} </a>
                    </div>
                    @endif
                    <div class="form-group">
                        {!! Form::label('grids', t('Shared grids')) !!}
                        <small>Además de la grilla propia del portfolioo, puede incorporar a la ficha las grillas compartidas que desee. <strong>Puede cambiar el orden de los items en la lista y dicho orden se respetará en la ficha.</strong></small>
            ...
            <div class="box box-solid box-primary">
                ...
                <div class="box-body">
                    <div class="form-group">
                        {!! Form::label('manuales', 'Descarga 1') !!}
                        <input class="file-upload" name="manuales" type="hidden" value='{{$item->info->manuales}}'>
                    </div>
                    <div class="form-group">
                        {!! Form::label('manuales_label', 'Nombre del botón de descarga 1') !!}
                        {!! Form::text('manuales_label', $item->info->manuales_label, ['class' => 'form-control', 'placeholder' => '']) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('flyer', 'Descarga 2') !!}
                        <input class="file-upload" name="flyer" type="hidden" value='{{$item->info->flyer}}'>
                    </div>
                    <div class="form-group">
                        {!! Form::label('flyer_label', 'Nombre del botón de descarga 2') !!}
                        {!! Form::text('flyer_label', $item->info->flyer_label, ['class' => 'form-control', 'placeholder' => '']) !!}
                    </div>
                </div>
            </div>
            ...
            <div class="box box-solid box-default">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <small>Sólo los usuarios que contengan el siguiente rol en su perfil o sean Super Administradores, van a poder realizar cambios en este portfolioo.</small>
            ...
            <div class="sticky" style="float: left;">
                ...
                <div class="box box-solid" >
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <a href="{{ route('portfolio.view', [$item->slug]) }}" class="btn btn-success pull-right" target="_blank"><i class="fa fa-eye"></i> {{t('View')}}</a>
                        </div>
                ...
                <div class="box box-solid ">
                    ...
                    <div class="box-body">
                        ...
                        <a class="btn btn-warning pull-right" href="{{ route('admin.portfolio.clone', [$item->id]) }}"><i class="fa fa-files-o"></i> {{t('Save as Copy')}}</a>
    ...
    {{ Form::open(['method' => 'DELETE', 'route' => ['admin.portfolio.edit', $item->id], 'name' => 'delete']) }}
    {{ Form::close() }}
...
@section('extra-js')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('input[name="rel_pages"]').formObjectList({
                placeholder: '{{t('Add')}}..',
                search: {
            ...
            function published_status(send=false){
                ...
                if(send){
                    $.ajax({
                      type:'PATCH',
                      url: '{{ route('admin.portfolio.state',['id' => $item->id]) }}',
                      processData: true,
                      data: {
                        state: state
                    },
        ...
        function saveForm(form){
            ...
            form.ajaxSubmit({
                url: '{{ route('admin.portfolio.edit',['id' => $item->id]) }}',
                type: 'post',
                dataType: 'json',
