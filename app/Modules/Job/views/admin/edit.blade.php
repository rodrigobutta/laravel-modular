...
@section('content')
            ...
            <div class="pull-right">
             {{--    <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="{{ route('admin.job.clone', [$item->id]) }}"> {{t('Current')}}</a></li>
                        <li><a href="{{ route('admin.job.clonex', [$item->id, 'uy']) }}">Uruguay</a></li>
                        <li><a href="{{ route('admin.job.clonex', [$item->id, 'ch']) }}">Chile</a></li>
                    </ul>
                </div> --}}
    ...
    <div class="row">
        ...
        <div class="col-md-3 sticky-parent">
            ...
            <div class="box box-solid sticky">
                <div class="box-body">
                    ...
                    <img src="{{ Resize::img($item->main_image,$item->receipts['featuredJob']) }}" class="img-responsive">
                   <ul id="nav_index">
                   </ul>
                </div>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="box box-solid box-primary ">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input name="main_image" type="hidden" class="image-field" value="{{$item->main_image}}" data-preview-recipe="featuredJob">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <small>Nombre que se usa para identificar el jobo en la URL. Debe cumplir con los standares de url.</small>
            ...
            {{--  <div class="box box-solid box-primary">
                ...
                <div class="box-body">
                    <small>Cuando un jobo se identifica como micrositio, el comportamiento en el sitio es el mismo que como un jobo normal, pero se reemplaza la ficha por un enlace (especificado en el campo de este cuadro) a un sitio externo que abre en <strong>ventana nueva</strong>.</small>
                    <div class="form-group">
            ...
            <div class="box box-solid box-primary">
                ...
                <div class="box-body">
                    @if($item->grid)
                    <div class="form-group">
                        {!! Form::label('grids', 'Grilla del jobo') !!}
                        <small>El siguiente botón lleva al editor de grillas para la grilla de este jobo.</small>
                        <a href="{{ route('admin.grids.live', [$item->grid->id]) }}" class="btn btn-primary" target="_blank"><i class="fa fa-th-large"></i> {{t('Grid Editor')}} </a>
                    </div>
                    @endif
                    <div class="form-group">
                        {!! Form::label('grids', t('Shared grids')) !!}
                        <small>Además de la grilla propia del jobo, puede incorporar a la ficha las grillas compartidas que desee. <strong>Puede cambiar el orden de los items en la lista y dicho orden se respetará en la ficha.</strong></small>
            ...
            <div class="box box-solid box-default">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <small>Sólo los usuarios que contengan el siguiente rol en su perfil o sean Super Administradores, van a poder realizar cambios en este jobo.</small>
            ...
            <div class="sticky" style="float: left;">
                ...
                <div class="box box-solid" >
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <a href="{{ route('job.view', [$item->slug]) }}" class="btn btn-success pull-right" target="_blank"><i class="fa fa-eye"></i> {{t('View')}}</a>
                        </div>
                ...
                <div class="box box-solid ">
                    ...
                    <div class="box-body">
                        ...
                        <a class="btn btn-warning pull-right" href="{{ route('admin.job.clone', [$item->id]) }}"><i class="fa fa-files-o"></i> {{t('Save as Copy')}}</a>
    ...
    {{ Form::open(['method' => 'DELETE', 'route' => ['admin.job.edit', $item->id], 'name' => 'delete']) }}
    {{ Form::close() }}
...
@section('extra-js')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function published_status(send=false){
                ...
                if(send){
                    $.ajax({
                      type:'PATCH',
                      url: '{{ route('admin.job.state',['id' => $item->id]) }}',
                      processData: true,
                      data: {
                        state: state
                    },
        ...
        function saveForm(form){
            ...
            form.ajaxSubmit({
                url: '{{ route('admin.job.edit',['id' => $item->id]) }}',
                type: 'post',
                dataType: 'json',
